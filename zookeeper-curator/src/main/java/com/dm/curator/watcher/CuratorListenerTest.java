package com.dm.curator.watcher;

import lombok.extern.slf4j.Slf4j;
import org.apache.curator.framework.CuratorFramework;
import org.apache.curator.framework.api.CuratorEvent;
import org.junit.Test;
import com.dm.base.CuratorBaseOperations;
...
public class CuratorListenerTest extends CuratorBaseOperations {
    ...
    public void testCuratorListener() throws Exception {
        ...
        curatorFramework.getCuratorListenable()
                .addListener((CuratorFramework client, CuratorEvent event) -> log.info(" things changed1: event: {},  {} ", event.getType().name(), event));
        String path = "/test";
        createIfNeed(path);
